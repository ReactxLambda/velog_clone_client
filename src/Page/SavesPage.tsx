    ...
    <div>
      ...
      {popup && (
        <Fragment>
          ...
          <div className="savesRemoveWrapper">
            <div className="savesRemove">
              <div>
                <h3>임시 글 삭제</h3>
                <div className="savesRemoveMessage">
                  임시 저장한 글을 삭제하시겠습니까? 삭제한 글은 복구할 수 없습니다.
                </div>
                <div className="buttonsWrapper">
                  <button className="savesRemoveCancel" onClick={() => setPopup(false)}>
                    취소
                  </button>
                  <button className="savesRemoveOk">확인</button>
                </div>
              </div>
            </div>
          </div>
